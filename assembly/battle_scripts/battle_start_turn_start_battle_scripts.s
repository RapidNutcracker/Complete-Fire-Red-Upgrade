...
BattleScript_SandstormBattleBegin:
	setword BATTLE_STRING_LOADER SandstormBattleBeginString
	printstring 0x184
	playanimation2 BANK_SCRIPTING ANIM_ARG_1 0x0
	waitmessage DELAY_1SECOND
	end3

BattleScript_RainBattleBegin:
	setword BATTLE_STRING_LOADER RainBattleBeginString
	printstring 0x184
	playanimation2 BANK_SCRIPTING ANIM_ARG_1 0x0
	waitmessage DELAY_1SECOND
	end3

BattleScript_HailBattleBegin:
	setword BATTLE_STRING_LOADER HailBattleBeginString
	printstring 0x184
	playanimation2 BANK_SCRIPTING ANIM_ARG_1 0x0
	waitmessage DELAY_1SECOND
	end3
...
BattleScript_FightingSpiritBegins:
	setword BATTLE_STRING_LOADER FightingSpiritBattleBeginString
	printstring 0x184
	playanimation BANK_SCRIPTING ANIM_FIGHTINGSPIRIT 0x0
	waitmessage DELAY_1SECOND
	end3
...
BattleScript_SolidRockBegins:
	setword BATTLE_STRING_LOADER SolidRockBeginsString
	printstring 0x184
	playanimation BANK_SCRIPTING ANIM_HARDEN 0x0
	waitmessage DELAY_1SECOND
	end3
