...
// extern const u8 gEventObjectPic_FalknerTiles[];
// static const struct SpriteFrameImage gEventObjectPicTable_Falkner[] =
// {
//     overworld_frame(gEventObjectPic_FalknerTiles, 4,  4, 0),
//     overworld_frame(gEventObjectPic_FalknerTiles, 4,  4, 1),
//     overworld_frame(gEventObjectPic_FalknerTiles, 4,  4, 2),
//     overworld_frame(gEventObjectPic_FalknerTiles, 4,  4, 3),
//     overworld_frame(gEventObjectPic_FalknerTiles, 4,  4, 4),
//     overworld_frame(gEventObjectPic_FalknerTiles, 4,  4, 5),
//     overworld_frame(gEventObjectPic_FalknerTiles, 4,  4, 6),
//     overworld_frame(gEventObjectPic_FalknerTiles, 4,  4, 7),
//     overworld_frame(gEventObjectPic_FalknerTiles, 4,  4, 8),
//     overworld_frame(gEventObjectPic_FalknerTiles, 4,  4, 9),
// };
...
//     .images = gEventObjectPicTable_Falkner,
