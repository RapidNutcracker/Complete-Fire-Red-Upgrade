...
const struct BattleMove gBattleMoves[] =
{
	...
	[MOVE_MEGAPUNCH] =
	{
		...
		.power = 80,
		.type = TYPE_NORMAL,
		.accuracy = 100,	// No reason to be less accurate
		.pp = 20,
		.secondaryEffectChance = 0,
		.target = MOVE_TARGET_SELECTED,
		.priority = 0,
	...
	[MOVE_BOUNCE] =
	{
		...
		.power = 85,
		.type = TYPE_FLYING,
		.accuracy = 90,	// Slightly worse than fly
		.pp = 5,
		.secondaryEffectChance = 30,
		.target = MOVE_TARGET_SELECTED,
		.priority = 0,
	...
	{
		.effect = EFFECT_BURN_HIT,
		.power = 65,	// Nerf BP due to high burn chance + change to be SE against Ice-type
		.type = TYPE_WATER,
		.accuracy = 100,
		.pp = 15,
		.secondaryEffectChance = 30,
...
const u8 gDynamaxMovePowers[MOVES_COUNT] =
{
	...
	[MOVE_BRAVEBIRD] = 100,		
	[MOVE_CHATTER] = 90,		
	[MOVE_DRAGONASCENT] = 100,	
	[MOVE_DRILLPECK] = 90,		
	[MOVE_DUALWINGBEAT] = 95,	
	[MOVE_FLY] = 100,			
	[MOVE_GUST] = 70,			
	[MOVE_HURRICANE] = 100,		
	[MOVE_OBLIVIONWING] = 100,	
	[MOVE_PECK] = 70,			
	[MOVE_PLUCK] = 80,			
	[MOVE_SKYATTACK] = 100,		
	[MOVE_WINGATTACK] = 80,		
