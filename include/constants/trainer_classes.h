...
enum
{
	CLASS_PKMN_TRAINER_1,	//0x0 brendan 
	CLASS_PKMN_TRAINER_2,	//0x1
	CLASS_AQUA_LEADER,		//0x2 admin 
	CLASS_TEAM_AQUA,		//0x3 last boss 
	CLASS_AROMA_LADY_RS,	//0x4 johto gym leader 
	CLASS_RUIN_MANIAC_RS,	//0x5 dumbass
	...
	CLASS_BUG_MANIAC,		//0x14 //friendly coach
